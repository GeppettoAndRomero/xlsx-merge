...
const CACHE_NAME = 'xlsx-merge-v1';
const RUNTIME_CACHE = 'xlsx-merge-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/xlsx-merge/',
  '/xlsx-merge/manifest.json',
  '/xlsx-merge/icon-192.png',
  '/xlsx-merge/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/xlsx-merge/manifest.json';
}
