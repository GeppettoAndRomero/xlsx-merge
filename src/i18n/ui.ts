...
export const ui = {
  en: {
    ...
    dzDropSub: 'XLSX and XLSM workbooks can be processed',
  ...
  ja: {
    ...
    dzDropTitle: 'ドロップで変換',
    dzDropSub: 'XLSX・XLSM ブックを処理できます',
  ...
  de: {
    ...
    dzDropSub: 'XLSX- und XLSM-Arbeitsmappen können verarbeitet werden',
  ...
  es: {
    ...
    dzDropSub: 'Se pueden procesar libros XLSX y XLSM',
